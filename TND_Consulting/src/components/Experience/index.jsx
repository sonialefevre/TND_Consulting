...
const Experience = () => {
  ...
  return (
    <div className="pageContainerExperience">
        ...
        {experiences.map((exp) => {
          return (
            <div
              key={uuid4()}
              className={
                slideIndex === experiences.indexOf(exp) + 1
                  ? "slider_experience slider_experience--active"
                  : "slider_experience"
              }
            >
              ...
              <div className="slider_experience_info">
                ...
                <p className="slider_experience_info_content">
                  {exp.countries}
                </p>
              </div>
              <div className="slider_experience_info">
